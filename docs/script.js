...
const tarotDescriptions = {
  de: {
    ...
    '22 superposition': 'Mehrere Wege existieren gleichzeitig.\nDein Fokus entscheidet, welche Realität kollabiert.',
    '23 observer': 'Der Beobachter verändert das Feld durch Präsenz.\nKlarheit entsteht, wenn du bewusst wahrnimmst statt zu reagieren.',
  ...
  en: {
    ...
    '22 superposition': 'Multiple paths exist at once.\nYour focus determines which reality collapses into form.',
    '23 observer': 'The observer changes the field through presence.\nClarity appears when you witness consciously instead of reacting.',
  ...
  ru: {
    ...
    '22 superposition': 'Несколько путей существуют одновременно.\nТвой фокус определяет, какая реальность проявится.',
    '23 observer': 'Наблюдатель меняет поле самим присутствием.\nЯсность приходит, когда ты осознаёшь, а не реагируешь импульсивно.',
